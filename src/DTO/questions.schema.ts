...
export const QuestionSchemaDal = z.object({
  ...
  answerText: z.array(AnswerSchemaDal).openapi({ description: 'List of possible answers for the question' }),
...
export const QuestionSchema = QuestionSchemaDal.omit({
    ...
    answerText: z.array(AnswerSchema).openapi({ description: 'List of possible answers for the question' }),
